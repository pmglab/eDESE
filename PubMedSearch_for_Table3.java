 ...
 */
//package com.snplife.common.util;
  ...
  public String pubMedIDESearch(List<String> diseaseNames, List<String> keyValues, List<String> filterValues) throws Exception {
    ...
    try {
      ...
      try ( //send data
        ...
        System.out.print(content1.toString());
        wr.flush();
      }
...
//      String dir="F:\\Projects\\TEA\\GWAS_tmp\\analysis\\TEA_analysis\\pvalue-rmHLA-Cond-fi\\transcript_tmp_0.01";
//      String failGenesFile=join(java.io.File.separator,dir,"log","failGenes.log.txt");
//      String errorGenesFile=join(java.io.File.separator,dir,"log","errorGenes.log.txt");
//      String result=join(java.io.File.separator,dir,"compareNCBI.txt");
//      BufferedReader br=LocalFileFunc.getBufferedReader(join(java.io.File.separator,dir,"comparedGenes.txt"));
//      
//      int i = 0;
//      String line;
//      Set<String> diseases = new HashSet();
//      if(new File(result).exists()){
//        BufferedReader brBreakpoint=TxtFileFunc.getBufferedReader(result);
//        while((line =brBreakpoint.readLine())!=null){
//            i++;
//            if(i==1){
//                continue;
//            }
//            diseases.add(line.split("\t")[0]);
//        }
//        brBreakpoint.close();
//      }
//      BufferedWriter bw=TxtFileFunc.getBufferedAppendWriter(result, false);
//      br.readLine();
//      String[]arr;
//      if(i==0){
//          bw.append("Disease\tNoGenesNCBI\tRankGenesNCBI\n");
//          bw.flush();
//      }
//
//      while((line=br.readLine())!=null){
//          arr=line.split("\t");
//          if(diseases.contains(arr[0])){
//              continue;
//          }
//          String no=getNCBIByDG(getDiseaseName(arr[0]),arr[1].split(","),errorGenesFile,failGenesFile);
//          String rank=getNCBIByDG(getDiseaseName(arr[0]),arr[2].split(","),errorGenesFile,failGenesFile);
//          bw.append(arr[0]+"\t"+no+"\t"+rank+"\n");
//          bw.flush();
//      }
//      bw.close();
//      br.close();
  }
  public static String getDiseaseName(String name){
      Map<String,String> dic=new HashMap();
      dic.put("BD", "bipolar disorder");
      dic.put("RA", "rheumatoid arthritis");
      dic.put("CAD", "coronary artery disease");
      dic.put("TC", "total cholesterol");
      dic.put("Height", "height");
  ...
  public static void mian_bak(){
      ...
      //File file =new File("transcript_eqtl_pubmed_results.txt");
      //BufferedWriter out = new BufferedWriter(new FileWriter("transcript_eqtl_pubmed_results.txt"));
      //FileWriter fileWritter = new FileWriter(file.getName(),true);
      //out.write("sdfsdfa");

      BufferedWriter out = new BufferedWriter(new FileWriter("E:\\000research\\SMR\\SMR_SCZ_results.txt"));

      //out.close();
      //System.out.println("Done");
      StringBuffer buffer = new StringBuffer();
      BufferedReader bf= new BufferedReader(new FileReader("E:\\000research\\SMR\\SMR_SCZ.lst"));
      String Line = null;
      List<String> selectedGenes = new ArrayList<>();
      while((Line = bf.readLine())!=null){//使用readLine方法，一次读一行
      ...
      //String[] selectedGenes = new String[]{"SLC45A1", "LINC01360", "MIR2682", "LOC105371433", "DNMT3A", "LINC01122", "MOB4", "TYW5", "LINC02033", "REEP2", "LINC01470", "ABCB1", "LOC101928782", "NSD3", "LOC102724623", "KYAT1", "SORCS3", "FSHB", "MIR3160-1", "TMX2", "PPP2R5B", "MIR4301", "MIR1228", "ATP2A2", "PITPNM2", "CHRNA5", "LOC440300", "FES", "TMEM219", "RPL13", "DRC3", "LINC02210-CRHR1", "TSSK6", "SNORD35B", "PPDPF", "MGAT3", "TOB2", "ACO2", "MEI1"};
      //String[] selectedGenes = new String[]{"SLC45A1", "LINC01360", "MIR2682", "LOC105371433", "DNMT3A", "LINC01122", "MOB4", "TYW5", "CREB1", "LINC02033", "REEP2", "LINC01470", "ABCB1", "LOC101928782", "NSD3", "LOC102724623", "KYAT1", "SORCS3", "MIR3160-1", "TMX2", "PPP2R5B", "MIR4301", "MIR1228", "PITPNM2", "CHRNA5", "LOC440300", "TMEM219", "RPL13", "DRC3", "LINC02210-CRHR1", "TSSK6", "SNORD35B", "SLC32A1", "PPDPF", "MGAT3", "TOB2", "ACO2", "MEI1"};
      //String[] selectedGenes = new String[]{"CYP26B1", "CENPM", "SND1", "NTRK3", "RBKS", "ETF1", "TMEM243", "MPHOSPH9", "PSCA", "CPNE7", "PSD3", "SPATS2L", "SLC7A6", "EIF5", "", "ALDOA", "BTBD18", "ENDOG", "METTL21A", "IL20RB", "DRD2", "PRICKLE2", "XRCC3", "LPAR2", "RERE", "NEGR1", "MIR137HG", "ECM1", "AKT3", "HSPD1", "C2orf69", "HPSE2", "DGKZ", "ATG2A", "PPP1R16B", "EEF1A2"};
      //Set<String> selectedGeneSet = new HashSet<String>(Arrays.asList(selectedGenes));
      Set<String> selectedGeneSet = new HashSet<String>(selectedGenes);
      //resources
      LocalFile.retrieveData("./HgncGene.txt", genes, indexes, "\t");
      //System.out.println((new File("hgncgene.gz")).getAbsolutePath());
      //LocalFile.retrieveData("hgncgene.gz", genes, indexes, "\t");
      ...
      for (String[] item : genes) {
        ...
        //out.write(item[0] + "\t" + item[1] + "\t" + pubmedID+"\n");
        out.write(item[0] + "\t" + item[1] + "\t" + pubmedID+"\n");
